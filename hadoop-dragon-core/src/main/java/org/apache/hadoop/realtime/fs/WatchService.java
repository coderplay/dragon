 ...
 * its {@link Watchable#register register} method, returning a {@link DefaultWatchKey}
 ...
 * invokes the key's {@link DefaultWatchKey#reset reset} method to reset the key which
 * allows the key to be signalled and re-queued with further events.
 *
 * <p> Registration with a watch service is cancelled by invoking the key's
 * {@link DefaultWatchKey#cancel cancel} method. A key that is queued at the time that
 ...
 * discards events then it arranges for the key's {@link DefaultWatchKey#pollEvents
    ...
    extends Closeable
{
     ...
     * valid keys associated with this watch service are {@link DefaultWatchKey#isValid
     * invalidated}.
     *
