...
import org.apache.hadoop.realtime.DSConstants;
 ...
 * the {@link DragonApplicationMaster} is launched. </p>
 * 
 * <p> The {@link ContainerLaunchContext} in this scenario defines the resources to be allocated for the 
 * {@link DragonApplicationMaster}'s container, the local resources (jars, configuration files) to be made available 
 * and the environment to be set for the {@link DragonApplicationMaster} and the commands to be executed to run the 
 * {@link DragonApplicationMaster}. <p>
 * 
...
public class DragonClient {
  ...
  /**
   */
  public DragonClient(Configuration conf) throws Exception  {
