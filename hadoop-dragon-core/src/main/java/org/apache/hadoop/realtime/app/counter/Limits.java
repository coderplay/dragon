...
public class Limits {
  ...
  public static final int GROUP_NAME_MAX =
      conf.getInt(DragonJobConfig.COUNTER_GROUP_NAME_MAX_KEY, DragonJobConfig.COUNTER_GROUP_NAME_MAX_DEFAULT);
  public static final int COUNTER_NAME_MAX =
      conf.getInt(DragonJobConfig.COUNTER_NAME_MAX_KEY, DragonJobConfig.COUNTER_NAME_MAX_DEFAULT);
  public static final int GROUPS_MAX =
      conf.getInt(DragonJobConfig.COUNTER_GROUPS_MAX_KEY, DragonJobConfig.COUNTER_GROUPS_MAX_DEFAULT);
  public static final int COUNTERS_MAX =
      conf.getInt(DragonJobConfig.COUNTERS_MAX_KEY, DragonJobConfig.COUNTERS_MAX_DEFAULT);
