...
import org.apache.hadoop.yarn.proto.DragonServiceProtos.FatalErrorRequestProtoOrBuilder;

public class FatalErrorRequestPBImpl extends ProtoBase<FatalErrorRequestProto>
    implements FatalErrorRequest {

  FatalErrorRequestProto proto = FatalErrorRequestProto.getDefaultInstance();
  FatalErrorRequestProto.Builder builder = null;
  boolean viaProto = false;

  private TaskAttemptId taskAttemptId = null;
  private String message = null;

  public FatalErrorRequestPBImpl() {
    builder = FatalErrorRequestProto.newBuilder();
  }

  public FatalErrorRequestPBImpl(FatalErrorRequestProto proto) {
    this.proto = proto;
    viaProto = true;
  }

  public FatalErrorRequestProto getProto() {
    mergeLocalToProto();
  ...
  private void maybeInitBuilder() {
    if (viaProto || builder == null) {
      builder = FatalErrorRequestProto.newBuilder(proto);
    }
    viaProto = false;
  }
  ...
  public TaskAttemptId getTaskAttemptId() {
    FatalErrorRequestProtoOrBuilder p = viaProto ? proto : builder;
    if (this.taskAttemptId != null) {
