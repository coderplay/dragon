...
public class DragonJobConfig {
  ...
  public static final String CACHE_FILES_SIZES = "dragon.job.cache.files.filesizes"; // internal use only
  ...
  public static final String APPLICATION_MASTER_CLASS =
      "org.apache.hadoop.realtime.server.DragonApplicationMaster";
  ...
  public static final String DRAGON_AM_COMMAND_OPTS =
    DRAGON_AM_PREFIX+"command-opts";
  public static final String DEFAULT_DRAGON_AM_COMMAND_OPTS = "-Xmx1536m";
  
  /** The amount of memory the DRAGON app master needs.*/
  public static final String DRAGON_AM_VMEM_MB =
    DRAGON_AM_PREFIX+"resource.mb";
  public static final int DEFAULT_DRAGON_AM_VMEM_MB = 2048;

  /** Root Logging level passed to the DRAGON app master.*/
  public static final String DRAGON_AM_LOG_LEVEL = 
    DRAGON_AM_PREFIX+"log.level";
  ...
  public static final String TASK_LOG_SIZE = DRAGON_PREFIX + "container.log.filesize";
 
  /** The staging directory for dragon.*/
  public static final String DRAGON_AM_STAGING_DIR = 
    DRAGON_AM_PREFIX+"staging-dir";
