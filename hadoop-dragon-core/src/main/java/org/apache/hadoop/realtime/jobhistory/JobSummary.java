...
public class JobSummary {
  ...
  private long numFinishedMaps;
  private long numFailedMaps;
  private long numFinishedReduces;
  private long numFailedReduces;
  private long resourcesPerMap; // resources used per map/min resource
  private long resourcesPerReduce; // resources used per reduce/min resource
  // resource models
  ...
  public long getNumFinishedMaps() {
  ...
  public long getResourcesPerMap() {
  ...
  public long getNumFinishedReduces() {
  ...
  public long getNumFailedReduces() {
  ...
  public long getResourcesPerReduce() {
