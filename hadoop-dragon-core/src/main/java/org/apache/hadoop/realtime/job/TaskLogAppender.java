...
public class TaskLogAppender extends FileAppender {
  private TaskAttemptId attemptId; // taskId should be managed as String rather
                                   // than TaskID object
  ...
  public void activateOptions() {
    synchronized (this) {
      ...
      setFile(TaskLog.getTaskLogFile(attemptId, isCleanup,
  ...
  /**
   * The Task Runner passes in the options as system properties. Set the options
   * if the setters haven't already been called.
   */
  ...
  public synchronized TaskAttemptId getAttemptId() {
    return attemptId;
  }

  public synchronized void setAttemptId(TaskAttemptId attemptId) {
