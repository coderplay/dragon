...
import org.apache.hadoop.yarn.proto.DragonProtos.CounterGroupProto;
import org.apache.hadoop.yarn.proto.DragonProtos.CountersProto;
import org.apache.hadoop.yarn.proto.DragonProtos.CountersProtoOrBuilder;
import org.apache.hadoop.yarn.proto.DragonProtos.StringCounterGroupMapProto;
...
public class CountersPBImpl extends ProtoBase<CountersProto> implements Counters {
  ...
  private void initCounterGroups() {
    ...
    this.counterGroups = new ConcurrentHashMap<String, CounterGroup>();
