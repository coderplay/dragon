...
public abstract class RMContainerRequestor extends RMCommunicator {
  ...
  public void init(Configuration conf) {
    ...
    nodeBlacklistingEnabled = 
      conf.getBoolean(DragonJobConfig.DRAGON_AM_JOB_NODE_BLACKLISTING_ENABLE, true);
    LOG.info("nodeBlacklistingEnabled:" + nodeBlacklistingEnabled);
    maxTaskFailuresPerNode = 
      conf.getInt(DragonJobConfig.MAX_TASK_FAILURES_PER_TRACKER, 3);
    blacklistDisablePercent =
        conf.getInt(
            DragonJobConfig.DRAGON_AM_IGNORE_BLACKLISTING_BLACKLISTED_NODE_PERECENT,
            DragonJobConfig.DEFAULT_DRAGON_AM_IGNORE_BLACKLISTING_BLACKLISTED_NODE_PERCENT);
